...
::: {.notes}
Alright, now moving to Bayes Factor
- you can see the calculated prior and posterior 
- probabilities for the hypothesis.
- Our calculated Bayes factor ends up being zero 
- due to the posterior odds. 


Because our bayes factor is less than one, 
- we can say that the plausibility of the 
- alternative hypothesis decreased in light of the 
- observed data

- Due to this bayes factor and our 95% posterior 
- credible interval, this confirms our belief
-  that the average flipper length is 
- not between 215mm and 225mm
...
:::: {#first-column}
 ...
 - Bayes Factor and CI indicated that $H_0$ should be rejected
    - $H_1$ is supported, average flipper length is not between $215mm$ and $225mm$
...
we had a prior flipper length of 193.37 mm 
with standard deviation of 6.12 mm

we had a predicted flipper length of 195.77 mm 
with a 0.86 mm standard deviation

There were no extra large penguins in our data
as we had a maximum flipper length of 212 mm

and as a result, our Bayes factor and 
95% credible interval indicated that we should 
