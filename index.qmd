...
The posterior predictive checks for the two models ($y_\text{rep}$) do not accurately capture the  observed values ($y$). The mean and variability of the predictions appear tp be higher than the observed values in both models.
...
The results from ordinary least squares regression are not identical to the results from the Bayesian regression, but there is remarkable similarity. 
...
- K-Fold CV and implications
- Neff and implications
- R-hat and implications
- PP checks and implications
- OLS Comparison and implications

#### 4.3 Consideration the Dataset

- how was data collected, by who and for what purpose, what impact might the results have, what biases are baked in to the analyses (scope of the data)
