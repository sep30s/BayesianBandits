...
neff_results_m1 <- bind_rows(fmdt_neff, dmdt_neff, tmdt_neff) 

neff_results_m2 <- bind_rows(fmdow_neff, dmdow_neff,tmdow_neff) 
...
rhat_results_m1 <- bind_rows(fmdt_rhat, dmdt_rhat, tmdt_rhat) 

rhat_results_m2 <- bind_rows(fmdow_rhat, dmdow_rhat,tmdow_rhat) 
