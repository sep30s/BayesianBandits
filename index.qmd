...
Delays %>%
  ...
  labs(x = "Time in Minutes",
       ...
       tag = "Figure 1. Histograms of Air Time and Flight Delays") +
  xlim(NA, 650)+
  scale_y_sqrt() +
...
```{r}
model <- flat_model_dow
ggarrange(mcmc_trace(model, size = 0.1) + ggtitle("Figure 13 (b) MCMC Trace"))
...
### 3.10 Frequentist OLS vs. Bayesian Regression
