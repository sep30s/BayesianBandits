...
## Comparison of the Models: K-Fold Cross Validation
...
-   **Key Insights**:
    ...
    -   Bayesian regression can converge with similar OLS models in the light of large datasets which leads to a decreasing influence of priors. 
        - There is no available test to estimate this tradeoff
