...
Table1.2 <- Delays1 %>%
  mutate(flight_duration = case_when(
    air_time < 60 ~ "Short-haul",
    air_time >= 60 & air_time  < 90 ~ "Light-Medium-haul",
    air_time  >= 90 & air_time  <= 120 ~ "Medium-haul", 
    air_time  > 120 ~ "Long-haul"
  )) %>%
